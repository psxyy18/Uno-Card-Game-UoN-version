...
while active:
    ...
    # PLAYING MODE SCREEN
        ...
        try:
            root.blit(pygame.image.load("C:/英国/Programming/project/UNO-main/uno_game/images/" + ess.current[1] + str(ess.current[0]) + ".png"), (580, 240))
        except:
            root.blit(pygame.image.load("C:/英国/Programming/project/UNO-main/uno_game/images/" + ess.current[1] + ".png"), (580, 240))
        ...
        for i in range(len(ess.player_list[0])):
            root.blit(
                pygame.image.load("C:/英国/Programming/project/UNO-main/uno_game/images/" + ess.player_list[0][i][1] + str(ess.player_list[0][i][0]) + ".png"),
                (590 - 50 * i, 470))
